function CustomValidation() {
  ...
  this.passwordRepeatValidityChecks = [];
}
...
var usernameValidityChecks = [
  {
    ...
    invalidityMessage: 'This input needs to be at least 3 charcters long',
    element: document.querySelector('label[for="username"] li:nth-child(1)')
  },
  {
    isInvalid: function(input) {
      var illegalCharacters = input.value.match(/[^a-zA-Z0-9]/gi);
